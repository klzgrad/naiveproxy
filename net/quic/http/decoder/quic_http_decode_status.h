...
#ifndef NET_QUIC_HTTP_DECODER_QUIC_HTTP_DECODE_STATUS_H_
#define NET_QUIC_HTTP_DECODER_QUIC_HTTP_DECODE_STATUS_H_
...
#endif  // NET_QUIC_HTTP_DECODER_QUIC_HTTP_DECODE_STATUS_H_
