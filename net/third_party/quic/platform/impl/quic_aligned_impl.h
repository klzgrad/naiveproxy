...
#ifndef NET_THIRD_PARTY_QUIC_PLATFORM_IMPL_QUIC_ALIGNED_IMPL_H_
#define NET_THIRD_PARTY_QUIC_PLATFORM_IMPL_QUIC_ALIGNED_IMPL_H_
...
#endif  // NET_THIRD_PARTY_QUIC_PLATFORM_IMPL_QUIC_ALIGNED_IMPL_H_
