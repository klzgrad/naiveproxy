...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_one_dcid, false, true, "If true, stores only one copy of the destination connection ID in QuicConnection::ReceivedPacketInfo.")
...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_reject_empty_cid_in_ncid, false, false, "If true, QUIC framer will reject NEW_CONNECTION_ID frames with empty connection IDs.")
