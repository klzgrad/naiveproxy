...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_bbr2_enable_bbpd_by_default, false, "If true, QUIC BBR2 will use a 0.91 PROBE_DOWN gain by default.")
...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_better_qpack_compression, false, "If true, use improved QPACK compression algorithm.")
...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_gfe_allow_alps_new_codepoint, true, "If true, allow quic to use new ALPS codepoint to negotiate during handshake for H3 if client sends new ALPS codepoint.")
...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_stop_reading_also_stops_header_decompression, false, "")
