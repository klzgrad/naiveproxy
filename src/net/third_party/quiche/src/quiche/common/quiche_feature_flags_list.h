...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_allow_host_in_request2, false, true, "If true, requests with a host header will be allowed.")
...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_deliver_stop_sending_to_zombie_streams, false, true, "If true, deliver STOP_SENDING to zombie streams.")
...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_fix_timeouts, false, true, "If true, postpone setting handshake timeout to infinite to handshake complete.")
