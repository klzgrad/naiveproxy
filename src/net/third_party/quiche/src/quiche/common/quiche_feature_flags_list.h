...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_enable_chaos_protection_v2, false, true, "If true, enable Chaos Protection v2 and use new QuicChaosProtector implementation.")
...
QUICHE_FLAG(bool, quiche_restart_flag_quic_use_new_qpack_blocking_manager, true, true, "If true, QUIC will use NewQpackBlockingManager instead of QpackBlockingManager.")
