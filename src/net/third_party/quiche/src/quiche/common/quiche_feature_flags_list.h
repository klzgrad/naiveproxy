...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_check_alternate_reset_token, true, true, "When true, checks the stateless reset token on a path probe using the alternate path's token")
