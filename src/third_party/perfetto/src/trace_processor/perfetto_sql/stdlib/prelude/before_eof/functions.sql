...
-- The result.
RETURNS STRING
DELEGATES TO __intrinsic_regexp_replace_simple;
...
-- The reversed string.
RETURNS STRING
DELEGATES TO __intrinsic_reverse;
...
RETURNS STRING
DELEGATES TO __intrinsic_base64_encode;
...
-- The decoded bytes.
RETURNS BYTES
DELEGATES TO __intrinsic_base64_decode;
...
RETURNS STRING
DELEGATES TO __intrinsic_demangle;
...
RETURNS STRING
DELEGATES TO __intrinsic_abs_time_str;
...
RETURNS STRING
DELEGATES TO __intrinsic_to_timecode;
