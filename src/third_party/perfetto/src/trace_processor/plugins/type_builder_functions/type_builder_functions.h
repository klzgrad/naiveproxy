...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_TYPE_BUILDER_FUNCTIONS_TYPE_BUILDER_FUNCTIONS_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_TYPE_BUILDER_FUNCTIONS_TYPE_BUILDER_FUNCTIONS_H_
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_TYPE_BUILDER_FUNCTIONS_TYPE_BUILDER_FUNCTIONS_H_
