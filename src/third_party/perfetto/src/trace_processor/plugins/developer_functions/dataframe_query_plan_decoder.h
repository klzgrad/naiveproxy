...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_DEVELOPER_FUNCTIONS_DATAFRAME_QUERY_PLAN_DECODER_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_DEVELOPER_FUNCTIONS_DATAFRAME_QUERY_PLAN_DECODER_H_
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_DEVELOPER_FUNCTIONS_DATAFRAME_QUERY_PLAN_DECODER_H_
