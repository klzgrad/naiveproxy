...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_PERF_TEXT_PERF_TEXT_SAMPLE_LINE_PARSER_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_PERF_TEXT_PERF_TEXT_SAMPLE_LINE_PARSER_H_
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_PERF_TEXT_PERF_TEXT_SAMPLE_LINE_PARSER_H_
