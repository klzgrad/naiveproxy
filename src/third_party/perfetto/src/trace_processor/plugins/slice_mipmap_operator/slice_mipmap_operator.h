...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_SLICE_MIPMAP_OPERATOR_SLICE_MIPMAP_OPERATOR_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_SLICE_MIPMAP_OPERATOR_SLICE_MIPMAP_OPERATOR_H_
...
// Registers the SliceMipmapOperator plugin with the global plugin set.
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_SLICE_MIPMAP_OPERATOR_SLICE_MIPMAP_OPERATOR_H_
