...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_ETM_ITERATE_RANGE_ETM_ITERATE_RANGE_VTABLE_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_ETM_ITERATE_RANGE_ETM_ITERATE_RANGE_VTABLE_H_
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_ETM_ITERATE_RANGE_ETM_ITERATE_RANGE_VTABLE_H_
