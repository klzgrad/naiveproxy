...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_PACKAGE_LOOKUP_PACKAGE_LOOKUP_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_PACKAGE_LOOKUP_PACKAGE_LOOKUP_H_
...
namespace perfetto::trace_processor::package_lookup {

// Registers the PackageLookup plugin with the global plugin set. Idempotent;
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_PACKAGE_LOOKUP_PACKAGE_LOOKUP_H_
