...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_CRITICAL_PATH_CRITICAL_PATH_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_CRITICAL_PATH_CRITICAL_PATH_H_

namespace perfetto::trace_processor::critical_path {
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_CRITICAL_PATH_CRITICAL_PATH_H_
