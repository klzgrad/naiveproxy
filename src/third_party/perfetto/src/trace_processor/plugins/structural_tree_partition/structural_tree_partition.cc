...
#include "src/trace_processor/plugins/structural_tree_partition/tables_py.h"
...
namespace structural_tree_partition {
namespace {

class StructuralTreePartitionPlugin
    : public Plugin<StructuralTreePartitionPlugin> {
 public:
  ~StructuralTreePartitionPlugin() override;
  ...
  void RegisterAggregateFunctions(
    ...
    out.push_back(MakeAggregateRegistration<StructuralTreePartition>(pool));
  }
};

StructuralTreePartitionPlugin::~StructuralTreePartitionPlugin() = default;
...
void RegisterPlugin() {
  static PluginRegistration reg(
      []() -> std::unique_ptr<PluginBase> {
        return std::make_unique<StructuralTreePartitionPlugin>();
      },
      StructuralTreePartitionPlugin::kPluginId,
      StructuralTreePartitionPlugin::kDepIds.data(),
      StructuralTreePartitionPlugin::kDepIds.size());
