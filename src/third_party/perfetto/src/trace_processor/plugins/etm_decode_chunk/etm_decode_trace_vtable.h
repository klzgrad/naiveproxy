...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_ETM_DECODE_CHUNK_ETM_DECODE_TRACE_VTABLE_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_ETM_DECODE_CHUNK_ETM_DECODE_TRACE_VTABLE_H_
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_ETM_DECODE_CHUNK_ETM_DECODE_TRACE_VTABLE_H_
