...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_WINSCOPE_IMPORTER_WINSCOPE_PROTO_MAPPING_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_WINSCOPE_IMPORTER_WINSCOPE_PROTO_MAPPING_H_
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_WINSCOPE_IMPORTER_WINSCOPE_PROTO_MAPPING_H_
