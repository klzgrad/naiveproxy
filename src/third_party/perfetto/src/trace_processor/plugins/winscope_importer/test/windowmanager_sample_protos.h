...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_WINSCOPE_IMPORTER_TEST_WINDOWMANAGER_SAMPLE_PROTOS_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_WINSCOPE_IMPORTER_TEST_WINDOWMANAGER_SAMPLE_PROTOS_H_
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_WINSCOPE_IMPORTER_TEST_WINDOWMANAGER_SAMPLE_PROTOS_H_
