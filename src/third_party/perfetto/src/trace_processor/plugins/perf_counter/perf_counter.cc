...
class PerfCounterPlugin : public Plugin<PerfCounterPlugin> {
 public:
  ~PerfCounterPlugin() override;
  void RegisterFunctions(PerfettoSqlConnection*,
    ...
    out.push_back(MakeFunctionRegistration<PerfCounterForSampleFunction>(
        std::make_unique<PerfCounterForSampleFunction::Context>(s)));
  }
};
PerfCounterPlugin::~PerfCounterPlugin() = default;
...
void RegisterPlugin() {
  static PluginRegistration reg(
      []() -> std::unique_ptr<PluginBase> {
        return std::make_unique<PerfCounterPlugin>();
      },
      PerfCounterPlugin::kPluginId, PerfCounterPlugin::kDepIds.data(),
      PerfCounterPlugin::kDepIds.size());
