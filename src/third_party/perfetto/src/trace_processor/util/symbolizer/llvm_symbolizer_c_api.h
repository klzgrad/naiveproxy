...
#ifndef SRC_TRACE_PROCESSOR_UTIL_SYMBOLIZER_LLVM_SYMBOLIZER_C_API_H_
#define SRC_TRACE_PROCESSOR_UTIL_SYMBOLIZER_LLVM_SYMBOLIZER_C_API_H_
...
#endif  // SRC_TRACE_PROCESSOR_UTIL_SYMBOLIZER_LLVM_SYMBOLIZER_C_API_H_
