...
enum PerfettoTeTimestampType {
  PERFETTO_TE_TIMESTAMP_TYPE_MONOTONIC = PERFETTO_DS_CLOCK_MONOTONIC,
  PERFETTO_TE_TIMESTAMP_TYPE_BOOT = PERFETTO_DS_CLOCK_BOOTTIME,
  PERFETTO_TE_TIMESTAMP_TYPE_INCREMENTAL = 64,
  PERFETTO_TE_TIMESTAMP_TYPE_ABSOLUTE = 65,
};

// Deprecated: Use PerfettoDsGetDefaultClockId() instead.
enum {
