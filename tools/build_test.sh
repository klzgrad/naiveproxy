...
config_openwrt() {
  ...
  target_cpu="$3"
  extra="$4"
  export EXTRA_FLAGS="target_cpu=\"$target_cpu\" target_os=\"openwrt\" use_allocator=\"none\" use_allocator_shim=false use_partition_alloc=false $extra"
  export OPENWRT_FLAGS="arch=$arch release=21.02.2 gcc_ver=8.4.0 $openwrt"
  ./get-clang.sh
}

#config_openwrt x86_64 'target=x86 subtarget=64' x64
#config_openwrt x86 'target=x86 subtarget=generic' x86
#config_openwrt aarch64_cortex-a53 'target=sunxi subtarget=cortexa53' arm64 'arm_cpu="cortex-a53"'
#config_openwrt aarch64_cortex-a72 'target=mvebu subtarget=cortexa72' arm64 'arm_cpu="cortex-a72"'
#config_openwrt aarch64_generic 'target=rockchip subtarget=armv8' arm64
#config_openwrt arm_arm1176jzf-s_vfp 'target=bcm27xx subtarget=bcm2708' arm 'arm_version=0 arm_cpu="arm1176jzf-s" arm_fpu="vfp" arm_float_abi="hard" arm_use_neon=false arm_use_thumb=false'
#config_openwrt arm_arm926ej-s 'target=mxs' arm 'arm_version=0 arm_cpu="arm926ej-s" arm_float_abi="soft" arm_use_neon=false arm_use_thumb=false'
...
#config_openwrt arm_cortex-a7 'target=mediatek subtarget=mt7629' arm 'arm_version=0 arm_cpu="cortex-a7" arm_float_abi="soft" arm_use_neon=false'
...
#config_openwrt arm_cortex-a9 'target=bcm53xx subtarget=generic' arm 'arm_version=0 arm_cpu="cortex-a9" arm_float_abi="soft" arm_use_neon=false'
...
#config_openwrt arm_mpcore 'target=oxnas subtarget=ox820' arm 'arm_version=0 arm_cpu="mpcore" arm_float_abi="soft" arm_use_neon=false arm_use_thumb=false'
...
#build_openwrt aarch64_cortex-a53 'target=sunxi subtarget=cortexa53' arm64 'arm_cpu="cortex-a53"'
#build_openwrt aarch64_cortex-a72 'target=mvebu subtarget=cortexa72' arm64 'arm_cpu="cortex-a72"'
#build_openwrt aarch64_generic 'target=rockchip subtarget=armv8' arm64
#build_openwrt arm_arm1176jzf-s_vfp 'target=bcm27xx subtarget=bcm2708' arm 'arm_version=0 arm_cpu="arm1176jzf-s" arm_fpu="vfp" arm_float_abi="hard" arm_use_neon=false arm_use_thumb=false'
#build_openwrt arm_arm926ej-s 'target=mxs' arm 'arm_version=0 arm_cpu="arm926ej-s" arm_float_abi="soft" arm_use_neon=false arm_use_thumb=false'
...
#build_openwrt arm_cortex-a7 'target=mediatek subtarget=mt7629' arm 'arm_version=0 arm_cpu="cortex-a7" arm_float_abi="soft" arm_use_neon=false'
...
#build_openwrt arm_cortex-a9 'target=bcm53xx subtarget=generic' arm 'arm_version=0 arm_cpu="cortex-a9" arm_float_abi="soft" arm_use_neon=false'
...
#build_openwrt arm_mpcore 'target=oxnas subtarget=ox820' arm 'arm_version=0 arm_cpu="mpcore" arm_float_abi="soft" arm_use_neon=false arm_use_thumb=false'
